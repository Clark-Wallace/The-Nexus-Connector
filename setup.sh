...
echo -e "     ${BLUE}source venv/bin/activate && python ui.py${NC}"
echo ""
echo "  Or use the CLI:"
echo -e "     ${BLUE}source venv/bin/activate${NC}"
echo -e "     ${BLUE}nexus chat${NC}                    # Interactive chat"
echo -e "     ${BLUE}nexus run \"Create a Flask app\"${NC}  # One-shot task"
echo ""
